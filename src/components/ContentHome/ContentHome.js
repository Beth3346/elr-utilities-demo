...
const contentHome = () => (
  <section className="content">
    ...
    <p>
      ...
      producivity I think that many of them will fall out of use in the future.
      JavaScript frameworks like React and Vue make it easier to create
      reusable, styled components. Using Sass with these frameworks can just
      create more trouble than it solves.
    </p>
    <p>
      I continue to use and maintain ELR Utilities because unfortunately not all
      of my projects use the most modern, cutting edge JavaScript frameworks.
      Sometimes I just need to build a WordPress theme or a landing page
      quickly. This is where a mixin library can really help producivity.
    </p>
    <h3 className="example-subheading">Recent Updates to ELR Utilities</h3>
    <p>
      Recently I decided to break up ELR Sass Utilities into smaller modules. I
      noticed that I typically only used a small number of mixins in each
      project so it really seemed uncessessary to include the entire libaray.
      All of these modules are available on npm. I have also added compiled CSS
      to each module for use in projects that don't use Scss.
    </p>
  </section>
);
